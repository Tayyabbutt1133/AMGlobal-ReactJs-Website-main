  ...
  return (
    <div className="bg-[#212121]">
      ...
      <div className="startApplingHeader">
        <div className="startApplingHeaderTextContainer">
          <p className="startApplingHeaderText">
            Get the Best Job <br />{" "}
            <strong className="text-[#c7af4c]"> You Deserve </strong>
          </p>
      ...
      <div className="cardMainContainer">
        <h3
          className="text-center md:text-start text-3xl pl-0 md:pl-12  pt-10 text-white font-semibold"
        >
          Choose Your Field
        </h3>
        ...
        <div className="cardContainer flex justify-center gap-12 pt-0 md:pt-10 p-10 flex-col md:flex-row">
          <div className="md:w-[30%]">
            {" "}
            <Card bgImage={manufacturing} heading={"Manufacturing"} />
          </div>
          <div className="md:w-[30%]">
            {" "}
            <Card bgImage={finance} heading={"Finance"} />
          </div>
          <div className="md:w-[30%]">
            {" "}
            <Card bgImage={IT} heading={"IT"} />
          </div>
        </div>
      </div>

      <button className="findVacBtn bg-[#B8A147]">
        Find Technical Vacancies
      </button>
      ...
      >
        ...
        >
          <div className="registerContainerChild">
            ...
            <button className="registerButton bg-[#171717]">
              Register Directly
            </button>
          </div>
        </div>
      ...
      <div
        data-aos="fade-up"
        className="signUpMainContainer group border border-[#EDD569]"
      >
        <h1
          style={{ color: "white", marginTop: "0px" }}
          className="lg:text-3xl md:pb-5 mb-5"
        >
      ...
      >
        ...
        <p className="text-xs md:text-sm py-5  md:py-10 px-0 md:px-10">
          ...
          doloribus mollitia minima quam hic, at commodi cum nostrum reiciendis
          numquam.
        </p>
