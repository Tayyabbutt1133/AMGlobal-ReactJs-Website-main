...
import chooseUsImg from "../assests/chooseUsImg.svg";
      ...
      <div className="chooseUsMainContainer">
        <div data-aos="fade-down-right" className="chooseUsMainContainerChild1">
          ...
          <p className="chooseUsMainContainerChild1Para">
            ...
            cutting-edge solutions for all your HR requirements. AM Global
            covering all the seven emirates and with plans of expansion to the
            GCC. We have experienced work force deployed across various industry
